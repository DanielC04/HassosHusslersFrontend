...
function UploadConglomerate({ handleFileChange }) {
    ...
    return <div className="m-auto flex flex-col items-center">
            <label for="floorplanupload" className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
                <svg className="fill-current w-4 h-4 mr-2" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 374.116 374.116" xml:space="preserve">
                    <g>
            ...
            <input id="floorplanupload" type="file" accept="application/pdf" onChange={handleFileChange}/>
        </div>;
}
    ...
    return <div className="flex">
            <div className="flex h-screen">
                <div className="my-auto">
                    ...
                    { floorArray.map(e => <FloorKnob value={e} handleBtnPress={handleFloorPress} isSelected={e == selectedFloor} hasFloorbtn={hasFloorbtn} setFloorbtnHavingness={() => setHasFloorbtn(true)}/>) }
